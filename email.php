...
<body>
    ...
    $db = mysqli_connect("localhost", "id20612153_root", ">a_8}iA>~}H23lYE", "id20612153_ags");
    $events = [
        "The hackathon" => "Hackathon",
        "The free fire tournament" => "Free Fire Tournament",
        "The fifa tournament" => "FIFA Tournament",
        "The valorant tournament" => "Valorant Tournament"
    ];
    ...
    try {
        ...
        $mail->Body = '
            <h1>Thank you for registering in ' .$event. ' hosted by the African Game Show!</h1>
