            ...
            <div class="container d-flex justify-content-center align-items-center">
                <div class="row">
                    ...
                    <div class="col-12 mt-auto mb-5 text-center">
                        ...
                        <h1 class="text-white mb-5">Africa Game Show</h1>
                    ...
                    <div class="col-lg-5 col-12">
                        <div class="artists-thumb">
                            ...
                            <div class="artists-hover">
                                <p><strong>Name:</strong>Lana Del Rey</p>
                                <p> <strong>Birthdate:</strong>1986</p>
                                <p> <strong>Music:</strong>alt-pop </p>
                                <hr>
                                <p class="mb-0">
                                    <strong>Youtube Channel:</strong>
                                    <a href="https://www.youtube.com/channel/UCqk3CdGN_j8IR9z4uBbVPSg">@LanaDelRey</a>
                                </p>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td style="background-color: #F3DCD4" class="table-background-image-wrap">
                                                <h3>Coding Night</h3>
                                                <p class="mb-2">5:00 AM - 5:00 AM</p>
                                                <div class="section-overlay"></div>
                                            </td>
